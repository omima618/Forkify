...
var _reciprViewJs = require("./views/reciprView.js");
var _reciprViewJsDefault = parcelHelpers.interopDefault(_reciprViewJs);
...
const controlRecipes = async function() {
    try {
        ...
        if (!id) return;
        _reciprViewJsDefault.default.renderSpinner();
        await _modelJs.loadRecipe(id);
        _reciprViewJsDefault.default.render(_modelJs.state.recipe);
    } catch (err) {
        _reciprViewJsDefault.default.renderError();
    }
};
const controlSearchResult = async function() {
    try {
        ...
        _resultViewJsDefault.default.render(_modelJs.state.search.results);
    } catch (err) {
    // console.log(err);
    }
};
const init = function() {
    _reciprViewJsDefault.default.addHandlerRender(controlRecipes);
    _searchViewJsDefault.default.addHandlerSearch(controlSearchResult);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/reciprView.js":"sFuQj","./views/searchView.js":"9OQAM","./views/resultView.js":"f70O5"}],"49tUX":[function(require,module,exports) {
...
},{"regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"sFuQj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view.js":"bWlJ9"}],"cMpiy":[function(require,module,exports) {
...
},{"./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../img/icons.svg":"cMpiy"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire3a11")
